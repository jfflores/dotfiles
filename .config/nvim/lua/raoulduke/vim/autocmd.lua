raoulduke.g.autocommand_callbacks = {}
...
local autocmd = function (name, pattern, cmd, opts)
  ...
  if cmd_type == 'function' then
    local key = raoulduke.util.get_key_for_fn(cmd, raoulduke.g.autocommand_callbacks)
    raoulduke.g.autocommand_callbacks[key] = cmd
    cmd = 'lua raoulduke.g.autocommand_callbacks.' .. key .. '()'
